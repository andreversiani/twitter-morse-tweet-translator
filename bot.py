...
input_user  = ''  #Coloque aqui o @ do twitter da pessoa
API_KEY = '' #API KEY
        ...
        if last_tweet.text[0] != '@':
            ...
            if pronto_pra_traduzir != '':      
                ...
                try:
                    ...
                    api.update_status(status='Em morse :  ' + tweet_traduzido, in_reply_to_status_id=last_tweet.id, auto_populate_reply_metadata=True)
